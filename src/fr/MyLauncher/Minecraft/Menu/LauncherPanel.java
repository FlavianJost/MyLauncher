...
import fr.RetroCraftPvP.MyLauncherLib.GameAuth;
...
public class LauncherPanel extends IScreen {
	...
	public LauncherPanel(Pane root, final GameEngine engine, GameFolder gamefolder) {
		...
		this.loginButton.setBounds(this.gameEngine.getWidth() - 285, this.gameEngine.getHeight() - 50, 90, 20);
		...
		this.loginButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				gameAuthentication=new GameAuth((String)config.getValue(EnumConfig.USERNAME), gamefolder, AccountType.RetrocraftPvP, "");
		...
		this.settingsButton.setBounds(this.gameEngine.getWidth() - 300, this.gameEngine.getHeight() - 85, 120, 20);
